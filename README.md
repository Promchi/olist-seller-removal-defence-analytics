...
the seller has completed a minimum of 10 orders citing that their products were bad.  
As the Data Analyst, I challenged this decision and recommended a data-driven investigation be 
conducted to determine the true root cause of the low ratings.

Before acting on this decision, a full data investigation was conducted to determine 
the true root cause of the low ratings — challenging the assumption that poor ratings 
reflect poor product quality.
...
**1. The seller has a statistically significant low rating**
10 out of 14 orders received a 1-star rating — a consistent pattern warranting 
investigation, not immediate removal.

**2. Distance is not the cause**
Orders travelling as little as 5km received 1-star ratings, while orders travelling 
331km and 417km received 4 and 5 stars. Distance has no correlation with low ratings.

**3. The carrier is not responsible**
The carrier delivery time for this seller was 8.00 days — virtually identical to 
the platform average of 8.85 days. The carrier performed normally.

**4. The seller's dispatch time is the root cause**
The platform average dispatch time is 2.74 days. This seller's late orders averaged 
21.11 days to dispatch — **7 times slower than the platform average.** All 9 late 
orders received a 1-star rating. Fast dispatch orders received 4 and 5 stars.

**5. Customers complained about delivery — not product quality**
Review comment analysis revealed dominant themes of delivery delays, missing orders, 
and status uncertainty. No comments mentioned product quality, broken items, 
or wrong items.
...
- Issue a formal warning if dispatch exceeds 5 days on any order
...
## Project Structure
```
olist-seller-defence-analytics/
...
The project follows a **raw to core pipeline** with a **dimensional model**:
...
- Geolocation coordinates are based on zip code prefixes — approximate, not exact
